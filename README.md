...
const lynn = {
  ...
  education: {
    ...
    institution: "Antonine University (2023 – 2026)",
    additional: "42 Beirut — Admitted Oct 2025"
  },
  techCommunities: {
    member1: "IEEE Student Branch (2025 – Current)",
    member2: "Robotics UA Society (2025 – Current)"
  },
  work: {
    title: "Software Engineering Intern",
    company: "FlexBox AI – Dubai (Remote)",
    periods: ["06/2024 – 07/2024", "01/2025 – 02/2025"]
  },
  languages: ["Arabic (native)", "English (fluent)", "French (fluent)"],
  currently: "Building Mockie — AI-powered voice interview prep platform 🎙️"
};
```
---
...
[![PLSQL](https://img.shields.io/badge/PLSQL-F80000?style=for-the-badge&logo=oracle&logoColor=black)](https://oracle.com)
